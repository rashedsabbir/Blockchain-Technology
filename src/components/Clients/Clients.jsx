        ...
        <div className="container px-4">
          <div className="grid grid-cols-12 mb-4 mb-md-5">
            <div className="col-span-12 md:col-span-8 md:col-start-3 text-center">
              <button className="overflow-hidden relative w-auto p-4 h-auto bg-zinc-700 text-white border-none rounded-md text-xl font-bold cursor-pointer relative z-10 group">
                Our Clients
                ...
                <span className="absolute w-36 h-32 -top-8 -left-0 bg-green-600 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-1000 duration-500 origin-bottom"></span>
                <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-4 left-6 z-10">
                  Join Us
                </span>
              </button>
            </div>
